                    ...
                    <v-expansion-panel-content>
                        <v-form ref="filterForm">
                            <v-row class="my-2" dense>
                                ...
                                <v-col cols="12" md="6">
                                    <v-autocomplete v-model="type" :items="roomTypeList" item-text="roomTypeList"
                                        label="Type" persistent-hint return-object clearable>
                                    </v-autocomplete>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-autocomplete v-model="laboratoryType" :items="laboratoryList.ALL"
                                        item-text="name" label="Laboratory" persistent-hint return-object
                                        clearable>
                                    </v-autocomplete>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-autocomplete v-model="building" :items="buildingList.ALL"
                                        item-text="name" label="Building" persistent-hint return-object
                                        clearable>
                                    </v-autocomplete>
                                </v-col>
                            </v-row>
        ...
        computed: {
            headers() {
                return [
                    ...
                    {
                        text: 'Laboratory Type',
                        value: 'laboratory.name',
                        width: '10%',
                        filter: f => {
                            if (this.laboratoryType != null) {
                                return f === this.laboratoryType.name
                            } else {
                                return f + ''
                            }
                        }
