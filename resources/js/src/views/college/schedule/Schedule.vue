                    ...
                    <v-expansion-panel-content>
                        <v-form ref="filterForm">
                            <v-row class="my-2" dense>
                                ...
                                <v-col cols="12" md="6">
                                    <v-autocomplete v-model="section" :items="sectionList.ALL" item-text="code"
                                        label="Section" persistent-hint return-object clearable>
                                    </v-autocomplete>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-autocomplete v-model="subject" :items="subjectList.ALL" item-text="name"
                                        label="Subject" persistent-hint return-object clearable>
                                    </v-autocomplete>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-autocomplete v-model="employee" :items="employeeList.ALL" item-text="fullName"
                                        label="Professor" persistent-hint return-object clearable>
                                    </v-autocomplete>
                                </v-col>
                            </v-row>
                        </v-form>
