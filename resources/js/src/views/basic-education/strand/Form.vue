                ...
                <div :class="inputVisibility">
                    <v-form ref="form" :value="valid" class="mx-3" lazy-validation>
                        <v-autocomplete v-model="branch" :items="branchList.ALL" item-text="name" label="Branch"
                            :rules="$rules.required('Branch')" :class="branchVisibility" return-object>
                        </v-autocomplete>
                        ...
                        <v-autocomplete v-model="itemsValue.track" :items="trackList" item-text="trackList"
                            label="Track" :rules="$rules.required('Track')" return-object>
                        </v-autocomplete>
                    </v-form>
