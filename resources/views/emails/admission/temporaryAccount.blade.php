...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-center">
      ...
      <div style="padding: 10px">You can now log in to SPCF Student Portal!</div>
    </div>
    ...
    <div class="sheet">
      ...
      <div>Here are your temporary credentials:</div>
      ...
      <div style="margin-top: 50px">
        This account will be used to check your current enrollment status, information and other matters regarding your enrollment!
      </div>

      <div style="margin-top: 50px">
        <a href="https://ictdevsms.azurewebsites.net/portal">Go to SPCF Student Portal</a>
      </div>
    </div>
