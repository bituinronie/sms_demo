...
class IndexUserAccountRepository extends BaseRepository
{
    public function execute() {
		...
		return $this->success("List of All User Account", $this->indexUserAccount($userAccount));
    }


    //*********************************************** CUSTOM FUNCTION ***********************************************//
    
    private function indexUserAccount($employee){
