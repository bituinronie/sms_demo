...
class ListStudentAccountRepository extends BaseRepository
{
    public function execute() {
		...
		if ($this->user()->employee->branch->type == "MAIN") {
			...
			$studentAccount = StudentAccount::onlyTrashed()->
			join(
		...
		return $this->success("List of All Student Account", $this->listStudentAccount($studentAccount));
    }

    //*********************************************** CUSTOM FUNCTION ***********************************************//

	private function listStudentAccount($studentAccount){
