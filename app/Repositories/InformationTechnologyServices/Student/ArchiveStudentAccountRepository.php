...
class ArchiveStudentAccountRepository extends BaseRepository
{
    public function execute($studentNumber){
        ...
        if (
            ...
            ActivityLog::create([
                ...
                "message" => "ARCHIVED AN STUDENT ACCOUNT",
                "causeTo" => [
        ...
        return $this->success("Student Account Successfuly Archived", ['studentNumber'=>$studentAccount->student_number]);
	}
}