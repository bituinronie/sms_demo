...
class IndexProofOfPaymentRepository extends BaseRepository
{
    public function execute() {
        ...
        elseif($this->user()->employee->branch->type == "SUB"){
            ...
            return $this->error("You're not authorized to view all proof of payments");
            
        }
        

        return $this->success("List of All Proof Of Payment", $this->indexProofOfPayment($proofOfPayment));
    }

    
	//*********************************************** CUSTOM FUNCTION ***********************************************//

    private function indexProofOfPayment($proofOfPayment){
