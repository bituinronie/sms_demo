...
class UpdateAdmissionRequest extends ResponseRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'emailAddress'                   => [
                                                ...
                                                'required', 
                                                'email', 
                                                'unique:applicant_personal_informations,email_address,'.$this->getPersonalId($this->priorityNumber)
                                                ],
            ...
            'currentAddressZipCode'          => ['required'],
            ...
            'profileImage'                 => ['sometimes', 'required', 'image', 'mimes:jpg,png,jpeg', 'max:5000'],
